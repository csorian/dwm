...
static const char *fonts[]          = { "SauceCodePro Nerd Font Mono:size=9:antialias=true:autohint=true" };
static const char dmenufont[]       = "SauceCodePro Nerd Font Mono:size=9:antialias=true:autohint=true";
